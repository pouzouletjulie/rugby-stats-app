...
CREATE TABLE public.player_match_stats (
  ...
  jap_engagement SMALLINT NOT NULL DEFAULT 0,
  jap_renvoi_22 SMALLINT NOT NULL DEFAULT 0,
  jap_renvoi_enbut SMALLINT NOT NULL DEFAULT 0,
...
SELECT
  ...
  SUM(pms.jap_engagement)::INTEGER AS jap_engagement,
  SUM(pms.jap_renvoi_22)::INTEGER AS jap_renvoi_22,
  SUM(pms.jap_renvoi_enbut)::INTEGER AS jap_renvoi_enbut,
